...
//HOME NAVBAR
import logo from "../../assets/img/project_imgs/hotel_img/logo.svg";
import {
  Button,
  Collapse,
  DropdownToggle,
      ...
      <Navbar className={"fixed-top" + navbarColor} color="white" expand="lg">
        <Container>
          <div className="navbar-translate">
            <NavbarBrand to="/hotel" tag={Link} id="navbar-brand">
              <img
                src={logo}
          ...
          <Collapse navbar>
            <Nav className="ml-auto" navbar>
              <NavLink to="/hotel/rooms" tag={Link}>
                <i
                  className="now-ui-icons design_image"
                  style={{ paddingLeft: "30px" }}
                ></i>
                <p style={{ paddingTop: "10px", paddingLeft: "4px", fontSize:'11px'}}>
                  <strong> ROOMS</strong>
                </p>
              </NavLink>
